...
<figure><img src="../../../../.gitbook/assets/image (120).png" alt=""><figcaption><p>这张图片展示了Jaeger的工作流程和架构，帮助我们理解如何使用Jaeger进行分布式追踪。为了更通俗易懂地介绍，我们可以将整个流程比作一个包裹物流系统。</p></figcaption></figure>
